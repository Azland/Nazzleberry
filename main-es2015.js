...
class AppComponent {
    constructor() {
        this.name = 'angular9-threejs';
        // WEB GL Three Render & Sizing
        const renderer = new three__WEBPACK_IMPORTED_MODULE_1__["WebGLRenderer"]({ antialias: true }); // Anti alias for smoof
        renderer.setSize(window.innerWidth, window.innerHeight);
        document.body.appendChild(renderer.domElement);
        // Scene
        const scene = new three__WEBPACK_IMPORTED_MODULE_1__["Scene"]();
        // Camera
        const camera = new three__WEBPACK_IMPORTED_MODULE_1__["PerspectiveCamera"](75, window.innerWidth / window.innerHeight, 1, 10000);
        // Orbit Controls
        const controls = new three_examples_jsm_controls_OrbitControls_js__WEBPACK_IMPORTED_MODULE_3__["OrbitControls"](camera, renderer.domElement); // Allows dragging of the scene, as well as scroll zoom.
        // Loader for GLTF
        const loader = new three_examples_jsm_loaders_GLTFLoader_js__WEBPACK_IMPORTED_MODULE_2__["GLTFLoader"]();
        // Set Clear Background &  Do colours
        ...
        loader.load('https://azland.github.io/Nazzleberry/assets/models/blend_blockmansign/scene.gltf', (gltf) => {
            ...
            // Centering test
            const box = new three__WEBPACK_IMPORTED_MODULE_1__["Box3"]().setFromObject(model);
            const center = box.getCenter(new three__WEBPACK_IMPORTED_MODULE_1__["Vector3"]());
            const size = box.getSize(new three__WEBPACK_IMPORTED_MODULE_1__["Vector3"]()).length();
        ...
        const intensity = 0.6;
        const ambientLight = new three__WEBPACK_IMPORTED_MODULE_1__["AmbientLight"](color, intensity);
        ...
        const material = new three__WEBPACK_IMPORTED_MODULE_1__["MeshBasicMaterial"]({ color: 0x338633 });
...
module.exports = __webpack_require__(/*! C:\Users\Aaron\angular9-threejs\src\main.ts */"./src/main.ts");
